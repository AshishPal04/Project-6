...
Ashish Pal
November 13 2023
Taven.hpp declares the Tavern class along with its private and public members
...
*/
    ...
    bool levelIsLess(const Character* lhs, const Character* rhs) const;
...
*/
    ...
    bool levelIsGreater(const Character* lhs, const Character* rhs) const;
...
*/
    ...
    bool vitalityIsLess(const Character* lhs, const Character* rhs) const;
...
*/
    ...
    bool vitalityIsGreater(const Character* lhs, const Character* rhs) const;
...
*/
    ...
    void createCombatQueue(string filter = "NONE");
...
*/
  ...
  private:
    ...
    */
    ...
    Character* main_character_; //A character pointer to the main characrer

    queue<Character*> combat_queue_; //A queue of Characters that are in the combat queue
    ...
    */
    ...
    void useBuff(Character* current_character, const bool& isMain);
    ...
    */
    ...
    void printDetails(Character* current_character) const;
};
#endif
